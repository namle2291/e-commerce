...
import { SaveOutlined, StopOutlined, UploadOutlined } from '@ant-design/icons';
...
function AddProduct() {
   ...
   const onSubmit = async (data) => {
      ...
      if (imageFile) formData.append('thumb', imageFile);
               ...
               <div className="col-span-4">
                  ...
                  <div className="p-2 border-dashed border-2">
                     ...
                     <div className="max-w-[250px] h-[250px] overflow-hidden my-2">
                        <img
                           src={previewImage ? previewImage : product?.thumb}
